...
#s0 = FWLiteSample.fromFiles("outliers", files = ["./data/pickevents_maria_badMuon.root"] )
s0 = FWLiteSample.fromFiles("outliers", files = ["./data/maria_infCand_RECO.root"] )
#s0 = FWLiteSample.fromFiles("outliers", files = ["./data/maria_badevents_mAOD.root "] )
